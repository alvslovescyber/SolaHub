...
public interface IVerseNoteRepository
{
    ...
    Task<IReadOnlyList<VerseNote>> GetByVerseRefAsync(VerseRef verseRef, bool sharedOnly = false, CancellationToken ct = default);
    Task<IReadOnlyList<VerseNote>> SearchByTagAsync(UserId userId, string tag, CancellationToken ct = default);
